...
public class ConcentrateCuerpoActivity extends AppCompatActivity implements View.OnClickListener{
    int fondo = R.drawable.img_concentrate;
    int [] listadoImagenes = {
            R.drawable.con_cabeza,
            R.drawable.con_brazo,
            R.drawable.con_pie,
            R.drawable.con_mano,
            R.drawable.con_tronco,
            R.drawable.con_cuello
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_concentrate_cuerpo);
    ...
    private void loadSplash() {
        ...
        Bundle b= new Bundle();
        b.putString("text_uno", "Selecciona las parejas de las partes del cuerpo correspondientes");
        b.putString("text_dos", "");
        b.putInt("img_uno", R.drawable.img_concentrate);
        b.putInt("img_dos", 0);
        Intent irActivity= new Intent(ConcentrateCuerpoActivity.this, SplashTodosActivity.class);
    ...
    private class Validar extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (numeroParejas==0){
                if (cont_good ==6) {
                    Intent irMenu = new Intent(getApplication(), Nivel64Activity.class);
