...
public class QuizFinal4Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_final4);
    ...
    private void irPantallaErrores() {
        ...
        if ((conCM==1 && conDOB==1 && conDIB==1 && conDUB==1) || (conCB==1 && conDOM==1 && conDIB==1 && conDUB==1) || (conCB==1 && conDOB==1 && conDIM==1 && conDUB==1) || (conDUM==1 &&conCB==1 && conDOB==1 && conDIB==1) ||
            ...
            if (cont_intentos>=2){
                Toast.makeText(this, "Quiz no superado debes repetir el nivel 4", Toast.LENGTH_LONG).show();
                Intent irNivelDos=new Intent(this, Nivel4Activity.class);
    ...
    private void irActivity() {
        Intent irNivelCuatro=new Intent(this, Nivel5Activity.class);
