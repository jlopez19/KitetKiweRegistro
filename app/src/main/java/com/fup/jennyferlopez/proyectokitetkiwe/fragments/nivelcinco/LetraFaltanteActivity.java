...
public class LetraFaltanteActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    TextView tv_title;
    int id_user;ServicioUsuario servicioUsuario;
    ...
    private void loadSplash() {
        ...
        Bundle b= new Bundle();
        b.putString("text_uno", "Selecciona las letras de los cuadros");
        ...
        b.putInt("img_dos", R.drawable.cania);
        Intent irActivity= new Intent(LetraFaltanteActivity.this, SplashTodosActivity.class);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.img_ayuda) {
            ...
            tv_reemplazar.setText("nxusxatasx");
            Thread timerThread = new Thread(){
                public void run(){
                    try{
                        ...
                        Intent ir=new Intent(getApplicationContext(), LetraFaltante2Activity.class);
                        startActivity(ir);
                        finish();
                    }
                }
