...
public class Nivel24Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel24);
    ...
    private void actualizarActivity() {
        ...
        if (usuario_por_id!=null) {
            servicioUsuario.actualizaractivity(usuario_por_id,"Nivel24Activity");
    ...
    public void onClick(View v) {
        if (v.getId()== R.id.correAvatar){
           // Toast.makeText(this, "sigue", Toast.LENGTH_SHORT).show();
            Intent ir= new Intent(this, ConcenConsonanActivity.class);
            startActivity(ir);
           finish();
        }
    }
