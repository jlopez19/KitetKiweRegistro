...
import com.fup.jennyferlopez.proyectokitetkiwe.fragments.nivelcinco.SopaAnimPlantActivity;
...
public class Nivel63Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel63);
    ...
    public void onClick(View v) {
        if (v.getId()== R.id.correAvatar){
            Intent irNumeros= new Intent(getApplication(), ConcentrateCuerpoActivity.class);
    ...
    private void actualizarActivity() {
        ...
        if (usuario_por_id!=null) {
            servicioUsuario.actualizaractivity(usuario_por_id,"Nivel63Activity");
