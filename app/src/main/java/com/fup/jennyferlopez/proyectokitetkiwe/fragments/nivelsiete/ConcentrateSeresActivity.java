...
import com.fup.jennyferlopez.proyectokitetkiwe.activities.PantallaFinalActivity;
...
import com.fup.jennyferlopez.proyectokitetkiwe.fragments.nivelseis.ConcentrateCuerpoActivity;
import com.fup.jennyferlopez.proyectokitetkiwe.fragments.nivelseis.Nivel64Activity;
...
public class ConcentrateSeresActivity extends AppCompatActivity implements View.OnClickListener {
    int fondo = R.drawable.img_concentrate;
    int [] listadoImagenes = {
            R.drawable.pata_sola,
            R.drawable.mojano,
            R.drawable.candileja,
            R.drawable.duende,
            R.drawable.img_ban,
            R.drawable.img_baston
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_concentrate_seres);
    ...
    private void loadSplash() {
        ...
        Bundle b= new Bundle();
        b.putString("text_uno", "Selecciona las parejas de los seres correspondientes");
        b.putString("text_dos", "");
        b.putInt("img_uno", R.drawable.img_concentrate);
        b.putInt("img_dos", 0);
        Intent irActivity= new Intent(ConcentrateSeresActivity.this, SplashTodosActivity.class);
    ...
    private class Validar extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (numeroParejas==0){
                if (cont_good ==6) {
                    Intent irMenu = new Intent(getApplication(), QuizNivel7Activity.class);
