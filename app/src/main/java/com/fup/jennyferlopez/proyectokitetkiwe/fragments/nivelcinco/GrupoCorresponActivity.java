...
public class GrupoCorresponActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grupo_correspon);
            ...
            Thread timerThread = new Thread(){
                public void run(){
                    try{
                        ...
                        Intent ir=new Intent(getApplicationContext(), Nivel52Activity.class);
                        startActivity(ir);
                        finish();
                    }
                }
