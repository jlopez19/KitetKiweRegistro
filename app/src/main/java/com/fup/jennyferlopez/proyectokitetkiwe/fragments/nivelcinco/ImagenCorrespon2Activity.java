...
public class ImagenCorrespon2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_imagen_correspon2);
            ...
            Thread timerThread = new Thread(){
                public void run(){
                    try{
                        ...
                        Intent ir=new Intent(getApplicationContext(), GrupoCorresponActivity.class);
                        startActivity(ir);
                        finish();
                    }
                }
