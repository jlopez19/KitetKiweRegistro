...
public class Nivel23Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void actualizarActivity() {
        ...
        if (usuario_por_id!=null) {
            servicioUsuario.actualizaractivity(usuario_por_id,"Nivel23Activity");
    ...
    public void onClick(View v) {
        if (v.getId()== R.id.correAvatar){
            Intent ir= new Intent(this, CompletaPalabraActivity.class);
            startActivity(ir);
            finish();
        }
    }
