...
public class Niveles31Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_niveles31);
    ...
    public void onClick(View v) {
        if (v.getId()== R.id.correAvatar){
            Intent ircolores= new Intent(getApplication(), ColorCorresActivity.class);
    ...
    private void actualizarActivity() {
        ...
        if (usuario_por_id!=null) {
            servicioUsuario.actualizaractivity(usuario_por_id,"Nivel31Activity");
