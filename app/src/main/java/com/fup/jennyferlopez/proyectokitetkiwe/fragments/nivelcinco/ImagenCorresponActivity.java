...
public class ImagenCorresponActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void loadSplash() {
        ...
        b.putInt("img_uno", R.drawable.col_maiz);
        b.putInt("img_dos", R.drawable.img_platano);
        Intent irActivity= new Intent(ImagenCorresponActivity.this, SplashTodosActivity.class);
    ...
    View.OnTouchListener handlerMover=new View.OnTouchListener(){
        ...
        private void cargarPuntos() {
            if (cont_good ==4) {
                Intent irMenu = new Intent(getApplication(), Nivel54Activity.class);
