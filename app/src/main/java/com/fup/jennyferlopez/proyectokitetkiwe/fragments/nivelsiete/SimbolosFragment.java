 ...
 */
public class SimbolosFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=  inflater.inflate(R.layout.fragment_simbolos, container, false);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.n_uno) {
            MediaPlayer mp = MediaPlayer.create(getActivity(), R.raw.bandera);
            mp.start();
        }else if (v.getId() == R.id.n_dos) {
            MediaPlayer mp = MediaPlayer.create(getActivity(), R.raw.baston);
            mp.start();
        }else if (v.getId() == R.id.n_cuatro) {
            MediaPlayer mp = MediaPlayer.create(getActivity(), R.raw.espiral);
            mp.start();
        }else if (v.getId() == R.id.n_cinco) {
            MediaPlayer mp = MediaPlayer.create(getActivity(), R.raw.escudo);
            mp.start();
        }
    }
