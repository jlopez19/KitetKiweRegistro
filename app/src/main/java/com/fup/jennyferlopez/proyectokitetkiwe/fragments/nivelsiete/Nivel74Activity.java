...
public class Nivel74Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel74);
    ...
    public void onClick(View v) {
        if (v.getId()== R.id.correAvatar){
             Intent irNumeros= new Intent(getApplication(), ConcentrateSeresActivity.class);
            startActivity(irNumeros);
            Toast.makeText(this, "Nivel siete", Toast.LENGTH_SHORT).show();
        }
    }
    private void actualizarActivity() {
        ...
        if (usuario_por_id!=null) {
            servicioUsuario.actualizaractivity(usuario_por_id,"MenuActivity");
