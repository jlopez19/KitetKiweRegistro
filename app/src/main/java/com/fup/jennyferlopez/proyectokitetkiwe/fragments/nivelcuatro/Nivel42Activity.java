...
public class Nivel42Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel42);
    ...
    public void onClick(View v) {
        if (v.getId()== R.id.correAvatar){
            Intent ircolores= new Intent(getApplication(),UnirPuntosActivity.class);
