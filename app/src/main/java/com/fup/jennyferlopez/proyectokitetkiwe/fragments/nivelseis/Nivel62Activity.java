...
public class Nivel62Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel62);
    ...
    public void onClick(View v) {
        if (v.getId()== R.id.correAvatar){
            Intent irNumeros= new Intent(getApplication(), LaberintoCuerpoActivity.class);
    ...
    private void actualizarActivity() {
        ...
        if (usuario_por_id!=null) {
            servicioUsuario.actualizaractivity(usuario_por_id,"Nivel62Activity");
