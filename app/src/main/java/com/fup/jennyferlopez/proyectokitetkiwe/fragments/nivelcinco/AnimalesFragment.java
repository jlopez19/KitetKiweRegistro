...
public class AnimalesFragment extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.n_uno) {
            MediaPlayer mp = MediaPlayer.create(getActivity(), R.raw.aveja);
            mp.start();
        }else if (v.getId() == R.id.n_dos) {
            MediaPlayer mp = MediaPlayer.create(getActivity(), R.raw.carpintero);
            mp.start();
        }else if (v.getId() == R.id.n_tres) {
            MediaPlayer mp = MediaPlayer.create(getActivity(), R.raw.pez);
            mp.start();
        }else if (v.getId() == R.id.n_cuatro) {
            MediaPlayer mp = MediaPlayer.create(getActivity(), R.raw.ardilla);
            mp.start();
        }else if (v.getId() == R.id.n_cinco) {
            MediaPlayer mp = MediaPlayer.create(getActivity(), R.raw.caracol);
            mp.start();
        }
    }
